...
function Home() {
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      {/* Main Content */}
      <div className="pt-28 pb-24 lg:pt-28 lg:pb-32 px-4 md:px-8 lg:px-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Card className="md:col-span-2 lg:col-span-2 lg:row-span-2 p-8 md:p-10">
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center gap-5 mb-8">
                  <img 
                    src={ProfilePhoto} 
                    alt="Nicolle Marinho" 
                    className="w-20 h-20 rounded-full object-cover ring-4 ring-pink-100 dark:ring-zinc-700"
                  />
                  <div>
                ...
                <div className="h-px bg-black/10 dark:bg-white/10 mb-8"></div>

                {/* Bio */}
                <div className="space-y-4 text-base md:text-lg text-gray-600 dark:text-gray-400 leading-relaxed flex-1">
                  <p>
                ...
                <div className="flex flex-wrap gap-3 mt-8">
                  ...
                  <Link 
                    to="/about" 
                    className="inline-flex items-center gap-2 px-6 py-3 border border-gray-200 dark:border-zinc-700 text-black dark:text-white rounded-full font-medium hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
                  >
                    Sobre mim
                  </Link>
                </div>
            ...
            <Link to="/work/aos-olhos-do-coracao" className="lg:col-span-1 lg:row-span-2 group">
              <Card className="h-full p-0 overflow-hidden">
                <div className="relative h-full min-h-80 flex flex-col">
                  ...
                  <div className="relative z-10 p-6 flex flex-col h-full">
                    ...
                    <div className="flex-1 flex items-center justify-center py-4">
                      <img 
                        ...
                        className="max-h-40 object-contain rounded-lg shadow-lg bg-white p-2"
                      />
                    </div>
                    ...
                    <div className="mt-auto">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-white/80 transition-colors duration-500">
                        Poesias e reflexões
                      </p>
                    </div>
                  </div>
            ...
            <Link to="/work/contos-em-preto-e-branco" className="lg:col-span-1 group">
              <Card className="h-full p-0 overflow-hidden min-h-50">
                  ...
                  <div className="relative z-10 p-6 flex flex-col h-full">
                    <div className="flex items-center gap-4">
                      <img 
                        ...
                        className="w-16 h-20 object-contain rounded bg-white p-1"
                      />
                      <div className="flex-1">
                        <span className="text-xs font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500 group-hover:text-white/70 transition-colors duration-500">
                          Contos
                        </span>
                        <h3 className="text-base font-bold text-black dark:text-white group-hover:text-white transition-colors duration-500">
            ...
            {/* Instagram Card */}
            <div className="md:col-span-1 lg:col-span-1 h-80">
              <InstagramCard />
            </div>
            ...
            {/* Contact CTA Card */}
            <Link to="/contact" className="md:col-span-2 group">
              <Card className="p-6 md:p-8 h-full overflow-hidden relative">
                ...
                <div className="relative z-10 flex items-center justify-between">
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-black dark:text-white group-hover:text-white transition-colors duration-500 mb-2">
                      Vamos conversar? 💜
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 group-hover:text-white/80 transition-colors duration-500">
                      Aberta a conversas e propostas de projetos
                    </p>
                  </div>
                  <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-zinc-800 group-hover:bg-white/20 flex items-center justify-center transition-colors duration-500 shrink-0">
                    <svg className="w-6 h-6 text-gray-600 dark:text-gray-300 group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                    </svg>
                  </div>
                </div>
