    ...
    <Card>
      <div className="flex items-center gap-4 mb-4">
        ...
        <div className="flex-1">
          <p className="font-medium text-black dark:text-white">Marco Cornacchia</p>
          <p className="text-gray-500 dark:text-gray-400 text-sm">@marco.ig</p>
        </div>
      ...
      <button className="w-full py-2.5 px-4 rounded-full border-2 border-black/10 dark:border-white/10 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-md hover:bg-white dark:hover:bg-zinc-700 transition-colors flex items-center justify-center gap-2">
        <span className="text-black dark:text-white font-medium">Ver perfil no Instagram</span>
