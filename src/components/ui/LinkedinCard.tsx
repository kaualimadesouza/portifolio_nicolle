...
import LinkedinPhoto from '../../assets/common/linkedin-photo.jpg';
  ...
  return (
    <Card className="group relative w-full h-full overflow-hidden p-4 sm:p-5 md:p-7 flex flex-col border border-pink-100 dark:border-zinc-700">
      ...
      <div className="relative z-10 flex items-center justify-between mb-3 sm:mb-5">
        <a href="https://www.linkedin.com/in/nicollemarinho/" className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="min-w-0">
            ...
            <div className="text-[10px] sm:text-[12px] text-gray-400 group-hover:text-blue-100 transition-colors duration-500 truncate">@nicollemarinhomartins</div>
          </div>
        </a>
        <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center shrink-0">
          <svg className="w-5 h-5 sm:w-7 sm:h-7 text-[#0077b5] group-hover:text-white transition-colors duration-500" fill="currentColor" viewBox="0 0 24 24">
