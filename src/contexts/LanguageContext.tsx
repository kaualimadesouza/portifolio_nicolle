...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    'home.bio2': 'Acredito na escrita como um campo expandido que envolve imagem, composição e a materialidade do livro. Meu processo criativo sempre esteve ligado à produção de imagens e ao pensamento visual.',
  ...
  en: {
    ...
    'home.bio2': 'I believe in writing as an expanded field that involves image, composition, and the materiality of the book. My creative process has always been linked to image production and visual thinking.',
